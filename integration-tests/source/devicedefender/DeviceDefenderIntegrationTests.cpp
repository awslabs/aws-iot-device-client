...
/**
 * To test Device Defender we are creating a Security Profile to create violations for any metrics output and using this
 * to facilitate testing this is a simple test to verify the metrics are being emitted by the Device Client by verifying
 * all metrics are causing violations
 */

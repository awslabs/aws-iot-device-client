            ...
            namespace Jobs
            {
                ...
                class JobsFeature : public Feature
                {
                  private:
                    ...
                    const std::string DEFAULT_JOBS_HANDLER_DIR = "/etc/device-client/handlers/";
                  ...
                  public:
                     ...
                     * @param dcConfig configuration information passed in by the user via either the command line or
                     * configuration file

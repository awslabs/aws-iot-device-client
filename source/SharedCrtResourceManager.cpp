...
int SharedCrtResourceManager::establishConnection(const PlainConfig &config)
{
     ...
     */
    auto onConnectionCompleted = [this, &connectionCompletedPromise](Mqtt::MqttConnection &, int errorCode, Mqtt::ReturnCode returnCode, bool) {
        if (errorCode)
        {
     ...
     */
    auto OnConnectionInterrupted = [this](Mqtt::MqttConnection &, int errorCode) {
        {
            if (errorCode)
            {
                LOGM_ERROR(
     ...
     */
    auto OnConnectionResumed = [this](Mqtt::MqttConnection &, int returnCode, bool) {
        {
